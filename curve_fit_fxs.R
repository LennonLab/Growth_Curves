...
#		- modified gompertz
#		- new 'modified' gompertz, with 2 extra parameters capable of long term decay
#		- confint.FI() function for calculating the Fisher Information confidence intervals; useful when profiling fails to converge/flat likelihood surfaces
#
